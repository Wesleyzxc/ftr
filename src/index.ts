...
function promptForSeconds(): void {
    rl.question('Please input the amount of time in seconds between emitting numbers and their frequency\n', (answer: string) => {
        const parsedAnswer = parseInt(answer);
        if (isNaN(parsedAnswer) || parsedAnswer <= 0) { // TODO: consider edge case return
